...
export default function QuizPage() {
  ...
  async function getHistoryAsync() {
    ...
    if (!localHistoryState.loading) {
      let newHistoryState: HistoryState = await getHistoryFunction();
      console.log(newHistoryState.historyArray);
